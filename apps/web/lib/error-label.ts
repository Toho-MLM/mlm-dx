export const ERROR_MESSAGES: Record<string, string> = {
  ...
  'RESERVATION_CANNOT_BE_EDITED': 'この予約は変更できません。',
  'RESERVATION_START_CANNOT_BE_CHANGED': '開始済みの予約では予約日と開始時刻を変更できません。',
  'RESERVATION_END_MUST_BE_IN_FUTURE': '終了時刻は現在時刻より後にしてください。',
  'BLOCKED_PERIOD_CONFLICT': '予約不可期間と重複しています。',
