        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm leading-relaxed text-foreground">
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li>利用したい時間枠と必須の希望利用時間を選び、必要に応じて希望開始・終了を入力します。部屋を選ぶ必要はありません。</li>
            </ol>
            ...
            <div className="overflow-x-auto rounded-md border">
              <table className="w-full min-w-[560px] text-sm">
                <thead>
                  <tr>
                    <th className={thClass}>希望開始・終了</th>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>希望利用時間は必須で、10〜240分、5分単位です。</li>
              <li>希望開始と希望終了は、両方を指定するか、両方とも指定しないでください。</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-foreground">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>抽選前は、部屋数、確定済み予約、希望条件の重なり、申込優先度から計算したおおよその当選確率が表示されます。</li>
              <li>当選確率は目安です。公平性スコアや同点抽選順位などにより、実際の結果とは異なる場合があります。</li>
