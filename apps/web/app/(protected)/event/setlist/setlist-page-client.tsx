              ...
              sectionEntriesWithSetlist.map(item => {
                return (
                  <div key={item.entry.id} className="border rounded-lg">
                    <div className="flex items-center justify-between gap-2 p-4 bg-gray-50/80">
                      <div className="flex items-baseline gap-4 min-w-0">
                        <span className="font-bold text-base text-gray-800 truncate max-w-[180px]">{item.groupName}</span>
                      </div>
