...
function SetlistContent({ initialEvents }: { initialEvents?: Event[] | null }) {
...
export function SetlistClient({ initialEvents }: { initialEvents?: Event[] | null }) {
  return (
    <Suspense fallback={
      <>
        <PageHeader />
      ...
      <SetlistContent initialEvents={initialEvents} />
    </Suspense>
  )
}
